    ...
    <div className="shell">
      ...
      <div className="legal-wrap">
        ...
        <div className="legal-summary">
          <h2>📋 L'essentiel</h2>
          <ul>
            <li>🛍️ <strong>Kimoxa est une marketplace</strong> : les vendeurs restent responsables de leurs offres et ventes.</li>
            ...
            <li>🛡️ <strong>Confiance et sécurité</strong> : fraude, contrefaçon et contournement des contrôles sont interdits.</li>
          </ul>
        </div>
