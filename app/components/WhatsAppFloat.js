...
export default function WhatsAppFloat() {
  ...
  return (
    <>
      ...
      `}</style>
      <a className="wa-float" href={`https://wa.me/${WHATSAPP_NUMBER}?text=${msg}`} target="_blank" rel="noopener noreferrer" aria-label="Support WhatsApp">
