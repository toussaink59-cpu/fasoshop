...
if (process.env.NODE_ENV === "production") {
  Sentry.init({
    ...
    tracesSampleRate: Number(process.env.NEXT_PUBLIC_SENTRY_TRACES_SAMPLE_RATE) || 0.2, // 20% par defaut ; cote client, necessite le prefixe NEXT_PUBLIC_ pour etre lisible par le navigateur
    enableLogs: true,
