    ...
    ">
      ...
      ">
        ...
        <p style="
          ...
          font-size: 13px;
        ">
          Kimoxa — l'Afrique qui vend à l'Afrique qui achète
        </p>
      </div>
      ...
      <div style="padding: 28px 24px;">
        ...
        ">
          ...
          En cas de question :
          <a
            href="mailto:support@kimoxa.com"
...
// FIRE-AND-FORGET : ne jamais bloquer l'appelant
// sur une panne Resend.
async function safeSend(to, subject, html) {
  // ---------------------------------------------------------
  // E2E : aucun appel réseau Resend.
  // ---------------------------------------------------------
  if (process.env.E2E_TEST_MODE === "1") {
    console.log(
      "[email/orders] E2E_TEST_MODE=1 — envoi Resend simulé",
      {
        to,
        subject,
      }
  ...
  if (!resend) {
    console.warn(
      "[email] RESEND_API_KEY non configure, email simule"
    );
...
export async function sendOrderPaidEmail({
  ...
  const html = wrap(
    `
      ...
      ">
        ...
        <strong>Votre paiement a été confirmé !</strong>
  ...
  return safeSend(
    to,
    `✅ Commande #${orderId} confirmée — Kimoxa`,
    html
  );
}
...
export async function sendOrderShippedEmail({
  ...
  const html = wrap(
    `
      ...
      ">
        ...
        <strong>
          ${shopName} vient d'expédier votre commande !
        </strong>
      ...
      ">
        ...
        après la réception pour signaler un problème.
  ...
  return safeSend(
    to,
    `🚚 Commande #${orderId} expédiée — Kimoxa`,
    html
  );
}
...
export async function sendOrderDeliveredEmail({
  ...
  return safeSend(
    to,
    `✅ Commande #${orderId} livrée — Kimoxa`,
    html
  );
}