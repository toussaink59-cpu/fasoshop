...
// RENFORCEMENT (audit pre-merge 14/09/2026) : HS256 se brise par
// brute-force offline si le secret est court. On impose 32 caractères
// minimum au démarrage plutôt que de découvrir le problème en prod.
if (JWT_SECRET.length < 32) {
  throw new Error("JWT_SECRET trop court (min 32 caractères) — génère-en un avec : openssl rand -hex 32");
}
