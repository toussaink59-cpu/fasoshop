...
// ✅ P2-11 : Parse explicite d'un booléen (fix ReferenceError + bug Boolean("false"))
...
export function validateCreateAddress(body) {
  ...
  const parDefaut = parseBoolean(body.parDefaut); // P1-11 : parse explicite
...
export function validateUpdateAddress(body) {
  ...
  if (body.parDefaut !== undefined) {
    data.parDefaut = parseBoolean(body.parDefaut); // P1-11 : parse explicite
  }
