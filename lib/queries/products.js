...
/**
 * Catalogue public — uniquement les produits ACTIFS, EN STOCK et de boutiques ACTIVES.
 ...
 *
 * IMPORTANT : Les produits en rupture de stock (stock_quantity = 0) sont MASQUÉS
 * du catalogue public (Temu-style). La page produit /shop/[id] reste accessible
 * via getProductDetail() pour les anciens liens, favoris et partages.
 *
...
// Marques distinctes utilisées par des produits actifs ET en stock, pour le filtre catalogue.
