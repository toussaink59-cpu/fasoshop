...
export async function getAdminConversations() {
  ...
  `;
    ...
    console.error('[adminConversations.js:getAdminConversations] DB error:', err.message);
    return [];
  }
}
...
export async function getAdminConversationThread(conversationId) {
  ...
  return { conversation, messages };
    ...
    console.error('[adminConversations.js:getAdminConversationThread] DB error:', err.message);
    return [];
  }
}
