...
export function getProvider() {
  ...
  if (name === "sandbox" && process.env.NODE_ENV === "production" && process.env.ALLOW_SANDBOX_IN_PROD !== "1") {
    throw new Error("Sandbox interdit en production (ALLOW_SANDBOX_IN_PROD=1 requis pour tests)");
  }
